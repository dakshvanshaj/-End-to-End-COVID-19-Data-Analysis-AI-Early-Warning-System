...
You are a Public Health Data Intelligence Officer. Generate a professional COVID-19 Situation Report in HTML format for {{ $json.count }}
states at risk.
...
## 🛠️ Combination 2: The National Executive Briefing (Complete Report)
